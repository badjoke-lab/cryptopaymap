...
expectIncludes('runner', files.runner, [
  ...
  "redirecthost = 'www.cryptopaymap.com'",
  ...
  'www_redirect_location_mismatch',
  'https://${redirecthost}/?p6_016_legacy',
...
expectIncludes('documentation', files.doc, [
  ...
  'apex is the canonical production host',
  'google verification txt',
  'exact retained vercel apex a and www cname',
  'same path/query',
  'candidate artifact',

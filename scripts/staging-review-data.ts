...
const places: PlaceSpec[] = [
  {
    slug: 'staging-coffee-tokyo',
    name: 'Staging Coffee Tokyo',
    category: 'cafe',
    countryCode: 'JP',
    locality: 'Tokyo',
    region: 'Tokyo',
  ...
  {
    slug: 'staging-ramen-shinjuku',
    name: 'Staging Ramen Shinjuku',
    category: 'restaurant',
    countryCode: 'JP',
    locality: 'Tokyo',
    region: 'Tokyo',
  ...
  {
    slug: 'staging-books-kanda',
    name: 'Staging Independent Books & Reading Room Kanda',
    category: 'bookstore',
    countryCode: 'JP',
    locality: 'Tokyo',
    region: 'Tokyo',
    ...
    restrictions: 'Ask staff before payment. Availability may depend on the register in use.',
  },
  {
    slug: 'staging-market-osaka',
    name: 'Staging Market Osaka',
    category: 'grocery',
    countryCode: 'JP',
    locality: 'Osaka',
    region: 'Osaka',
  ...
  {
    slug: 'staging-hotel-namba',
    name: 'Staging Hotel Namba',
    category: 'hotel',
    countryCode: 'JP',
    locality: 'Osaka',
    region: 'Osaka',
    ...
    restrictions:
      'Crypto payment is available for direct bookings made through the hotel front desk.',
  },
  {
    slug: 'staging-gallery-yokohama',
    name: 'Staging Gallery Yokohama',
    category: 'gallery',
    countryCode: 'JP',
    locality: 'Yokohama',
    region: 'Kanagawa',
  ...
  {
    slug: 'staging-bakery-sapporo',
    name: 'Staging Bakery Sapporo',
    category: 'bakery',
    countryCode: 'JP',
    locality: 'Sapporo',
    region: 'Hokkaido',
  ...
  {
    slug: 'staging-cowork-fukuoka',
    name: 'Staging Cowork Fukuoka',
    category: 'coworking',
    countryCode: 'JP',
    locality: 'Fukuoka',
    region: 'Fukuoka',
  ...
  {
    slug: 'staging-design-seoul',
    name: 'Staging Design Store Seoul',
    category: 'retail',
    countryCode: 'KR',
    locality: 'Seoul',
    region: null,
  ...
  {
    slug: 'staging-noodle-singapore',
    name: 'Staging Noodle House Singapore',
    category: 'restaurant',
    countryCode: 'SG',
    locality: 'Singapore',
    region: null,
  ...
  {
    slug: 'staging-cycle-london',
    name: 'Staging Cycle Workshop London',
    category: 'bicycle',
    countryCode: 'GB',
    locality: 'London',
    region: 'England',
  ...
  {
    slug: 'staging-studio-new-york',
    name: 'Staging Creative Studio New York',
    category: 'studio',
    countryCode: 'US',
    locality: 'New York',
    region: 'New York',
  ...
  {
    slug: 'staging-florist-paris',
    name: 'Staging Florist Paris',
    category: 'florist',
    countryCode: 'FR',
    locality: 'Paris',
    region: null,
  ...
  {
    slug: 'staging-surf-sydney',
    name: 'Staging Surf Shop Sydney',
    category: 'retail',
    countryCode: 'AU',
    locality: 'Sydney',
  ...
  {
    slug: 'staging-records-berlin',
    name: 'Staging Records Berlin',
    category: 'music',
    countryCode: 'DE',
    locality: 'Berlin',
    region: null,
  ...
  {
    slug: 'staging-tea-taipei',
    name: 'Staging Tea Room Taipei',
    category: 'cafe',
    countryCode: 'TW',
    locality: 'Taipei',
    region: null,
  ...
  {
    slug: 'staging-closed-diner-kyoto',
    name: 'Staging Closed Diner Kyoto',
    category: 'restaurant',
    countryCode: 'JP',
    locality: 'Kyoto',
    region: 'Kyoto',
  ...
  {
    slug: 'staging-ended-shop-toronto',
    name: 'Staging Ended Shop Toronto',
    category: 'retail',
    countryCode: 'CA',
    locality: 'Toronto',
    region: 'Ontario',
...
const services: ServiceSpec[] = [
  ...
  },
  {
    ...
    acceptanceScope: 'new_purchase_only',
    restrictions:
      'Available for new annual plans. Renewal availability may differ by account region.',
  },
  {
    slug: 'staging-domain-shop',
    name: 'Staging Domain Shop',
    category: 'domains',
    countryCode: 'US',
    status: 'confirmed',
    routeType: 'direct_wallet',
  ...
  {
    slug: 'staging-design-tools',
    name: 'Staging Design Tools Pro',
    category: 'software',
    countryCode: null,
    status: 'confirmed',
    routeType: 'processor_checkout',
  ...
  {
    slug: 'staging-travel-booking',
    name: 'Staging Travel Booking',
    category: 'travel',
    countryCode: null,
    status: 'confirmed',
    routeType: 'processor_checkout',
    ...
    acceptanceScope: 'region_limited',
    restrictions: 'Availability depends on the departure market and selected supplier.',
  },
  {
    slug: 'staging-learning',
    name: 'Staging Learning Platform',
    category: 'education',
    countryCode: 'GB',
    status: 'stale',
    routeType: 'direct_wallet',
  ...
  {
    slug: 'staging-media-subscription',
    name: 'Staging Media Subscription',
    category: 'media',
    countryCode: null,
    status: 'confirmed',
    routeType: 'processor_checkout',
  ...
  {
    slug: 'staging-ended-saas',
    name: 'Staging Ended SaaS',
    category: 'software',
    countryCode: 'CA',
    status: 'ended',
    routeType: 'processor_checkout',
  ...
  {
    slug: 'staging-gift-cards',
    name: 'Staging Gift Cards Marketplace With An Intentionally Long Service Name',
    category: 'gift-cards',
    countryCode: null,
    status: 'confirmed',
    routeType: 'direct_wallet',
    ...
    acceptanceScope: 'selected_products',
    howToPay:
      'Choose an eligible gift card, select the cryptocurrency payment option, generate the invoice, confirm the asset and network shown in the checkout, and complete payment before the invoice expires.',
  },
];
...
function evidence(slug: string) {
  return {
    ...
    publishedAt: null,
    summary:
      'Synthetic staging evidence used only to exercise reviewed public presentation states.',
  };
}
...
export function buildStagingReviewData() {
  ...
  return {
    ...
    stats: publicStatsSchema.parse({
      ...
      staleRecords:
        places.filter((spec) => spec.status === 'stale').length +
        services.filter((spec) => spec.status === 'stale').length,
      endedRecords:
        places.filter((spec) => spec.status === 'ended').length +
        services.filter((spec) => spec.status === 'ended').length,
      directWalletClaims: allActive.filter((spec) => spec.routeType === 'direct_wallet').length,
      processorCheckoutClaims: allActive.filter((spec) => spec.routeType === 'processor_checkout')
        .length,
      howToPayCoverage: 1,

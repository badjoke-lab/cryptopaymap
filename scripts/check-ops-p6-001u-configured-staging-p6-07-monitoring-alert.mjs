...
const expectations = [
  ...
  [files.procedure, 'Duplicate convergence'],
  [files.procedure, 'intentionally delayed escalation comment'],
  ...
  [files.executor, 'comments?per_page=100&page=${page}'],
